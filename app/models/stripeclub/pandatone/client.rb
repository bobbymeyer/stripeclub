...
module Stripeclub
  module Pandatone
    class Client
      ...
      def self.configured
        new(url: Stripeclub.pandatone_url, token: Stripeclub.pandatone_token)
      end
      ...
      def palettes
        palettes_json.map { |json| Pandatone::Palette.from_json(json) }
      end

      # The same, as the wire format: what Stripeclub.palette_source answers.
      def palettes_json
